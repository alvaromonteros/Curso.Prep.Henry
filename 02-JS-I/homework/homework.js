...
function multiplica(x, y) {
 ...
 return multiplicacion // Multiplica "x" por "y" y devuelve el valor
  // Tu código:
...
function menosQueNoventa(num) {
  ...
  return false;// Devuelve "true" si el argumento de la función "num" es menor que noventa
  // De lo contrario, devuelve "false"
  // Tu código:
...
function esImpar(num) {
  ...
  return false  // Devuelve "true" si "num" es impar
  // De lo contrario, devuelve "false"
  // Tu código:
